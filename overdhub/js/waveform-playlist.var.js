	    ...
	    value: function setUpEventEmitter() {
	      ...
	      ee.on('mute', function (track) {
	        ...
	        _this2.drawRequest();
				...
				ee.on('downloadtrack', function (track) {
					_this2.adjustTrackPlayout();
					_this2.drawRequest();
				});
	  ...
	  _createClass(_class, [{
	    ...
	    */
	    ...
	    value: function renderControls(data) {
	      ...
	      }, [(0, _h2.default)('header.truncate', [this.name]), (0, _h2.default)('div.btn-group', [(0, _h2.default)('span.leading-none.rounded.py-1.text-xs.px-2.neumorphism-shadow.neumorphism-inner.hover:bg-transparent.cursor-pointer.btn-mute' + muteClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('mute', _this2);
	        }
	      }, ['Mute']), (0, _h2.default)('span.leading-none.rounded.py-1.px-2.text-xs.neumorphism-shadow.neumorphism-inner.hover:bg-transparent.cursor-pointer.btn-solo' + soloClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('solo', _this2);
	        }
				}, ['Solo']), (0, _h2.default)('span.leading-none.rounded.py-1.px-2.text-xs.neumorphism-shadow.neumorphism-inner.hover:bg-transparent.cursor-pointer.btn-delete' + deleteClass, {
	        onclick: function onclick() {
	          _this2.ee.emit('downloadtrack', _this2);
	        }
	      }, ['Download'])]), (0, _h2.default)('label', [(0, _h2.default)('input.volume-slider', {
	        attributes: {
	          type: 'range',
	          min: 0,
	          max: 100,
